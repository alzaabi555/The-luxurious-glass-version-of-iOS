...
return (
  <div className="flex flex-col h-full text-slate-800 relative bg-[#f3f4f6]">
      ...
      {/* ================= Header الثابت ================= */}
      {/* fixed: لضمان الثبات فوق المحتوى وتغطية النوتش
          bg-[#eef2ff]: اللون الأزرق الفاتح الذي اخترته للتميز
          z-50: ليظهر فوق القائمة المتحركة
      */}
      ...
      {/* ================= القائمة + الفاصل ================= */}
      {/* 1. h-full: لتأخذ القائمة كامل الشاشة.
          2. الفاصل (Spacer) بداخلها: ليضمن أن أول اسم يظهر تحت الهيدر.
          3. عند التمرير: الفاصل يصعد للأعلى ويختفي خلف الهيدر، وتلحق به الأسماء.
      */}
      <div className="h-full overflow-y-auto custom-scrollbar">
          
          {/* الفاصل الوهمي (يساوي تقريباً ارتفاع الهيدر) */}
          <div className="w-full h-[180px] shrink-0"></div>

          <div className="px-1 pb-24 pt-2">
      ...
      <Modal isOpen={!!showNegativeReasons} onClose={() => setShowNegativeReasons(null)} className="max-w-xs rounded-[2rem]">
          <div className="text-center">
              ...
              <div className="grid grid-cols-2 gap-2 mb-4">
                  {['إزعاج', 'نسيان كتاب', 'نوم', 'تأخر', 'ألفاظ', 'شجار', 'الاكل اثناء الحصة'].map(r => (
